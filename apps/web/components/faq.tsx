  ...
  return (
    <section id="faq" className="section faq-section">
      <div className="shell faq-layout">
        <div><span className="eyebrow">FAQ</span><h2 className="section-title">Clear answers for operators and partners.</h2><p className="section-copy">The product keeps authority, settlement and evidence boundaries explicit by design.</p></div>
